...
//   case 1:
//        if (P1) { P1_P=1; LED1=1;}
//        else if (KZ1) {P1_P=0; LED=0;}
//}

switch (P1) {
    case 0:
        break;
    case 1: P1_P=1; LED1=1;
        break;
...
switch (stan) {
        case 1: PGA = 0; PDA = 0;
            if ( (P2_P || P3_P || P4_P) && !tim ) stan = 2;
            break;
        case 2: PGA = 1; PDA = 0; 
            if ( KZ2 ) { tim = 300; stan = 3; P2_P=0; LED2=0;}   
            break;

        case 3: PGA = 0; PDA = 0;
            if ( P1_P && !tim ) stan = 4;
            else if ( (P3_P || P4_P) && !tim ) stan = 5;
            break;
        case 4: PGA = 0; PDA = 1; 
            if ( KZ1 ) { tim = 300; stan = 1; P1_P=0; LED1=0;}
            break;
        case 5: PGA = 1; PDA = 0; 
            if ( KZ3 ) { tim = 300; stan = 6; P3_P=0; LED3=0;}
            break;

        case 6: PGA = 0; PDA = 0;
            if ( P4_P && !tim ) stan = 7;
            else if ( (P1_P || P2_P) && !tim ) stan = 8;
            break;
        case 7: PGA = 1; PDA = 0; 
            if ( KZ4 ) { tim = 300; stan = 9; P4_P=0; LED4=0;}
            break;
        case 8: PGA = 0; PDA = 1; 
            if ( KZ2 ) { tim = 300; stan = 3; P2_P=0; LED2=0;}
            break;
